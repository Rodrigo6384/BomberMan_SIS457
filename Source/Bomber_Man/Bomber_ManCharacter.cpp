...
ABomber_ManCharacter::ABomber_ManCharacter()
{
	...
	// Cambiar la rotación para una vista aérea
	CameraBoom->SetWorldRotation(FRotator(-90.0f, 0.0f, 0.0f));  // La cámara se coloca hacia abajo
...
void ABomber_ManCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("ResetVR", IE_Pressed, this, &ABomber_ManCharacter::OnResetVR);
}


void ABomber_ManCharacter::OnResetVR()
{
	// If Bomber_Man is added to a project via 'Add Feature' in the Unreal Editor the dependency on HeadMountedDisplay in Bomber_Man.Build.cs is not automatically propagated
